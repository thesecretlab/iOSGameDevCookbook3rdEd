...
class TestScene: SKScene {
    ...
    func createSceneContents() {
        ...
        if true {
            ...
            node.run(action, withKey: "My Action")
            // END action_with_key
            
            // BEGIN get_action_with_key
            let theAction = node.action(forKey: "My Action")
            // END get_action_with_key
            
            // BEGIN remove_action_with_key
            node.removeAction(forKey: "My Action")
        ...
        let animationAction = SKAction.animate(with: allTextures,
    ...
    func shakeNode(node: SKNode) {
        ...
        for i in 0...shakeSteps  {
            ...
            // add it to the list
            let shakeMovementAction = SKAction.move(to: shakePosition,
        ...
        node.run(shakeSequence, withKey:"shake")
