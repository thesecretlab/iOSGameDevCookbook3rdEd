...
class ViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        // Make the material be green and shiny
        ...
        let tapRecognizer
            = UITapGestureRecognizer(target: self, action: #selector(ViewController.tapped(tapRecognizer:)))
        ...
        let critterDataURL =
            Bundle.main.url(forResource: "Critter",
                                               withExtension: "dae")
    ...
    @objc func tapped(tapRecognizer: UITapGestureRecognizer) {
        ...
        if tapRecognizer.state == UIGestureRecognizerState.ended {
            ...
            let locationToQuery =
                tapRecognizer.location(in: tapRecognizer.view)
